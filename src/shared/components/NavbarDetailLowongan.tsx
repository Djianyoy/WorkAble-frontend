...
import { ArrowDownIcon, ChevronDown, Home, Hotel, Hourglass, HouseHeart, HousePlug, HousePlus, HouseWifi, LogOut, LogOutIcon, LucideHome, VectorSquare } from 'lucide-react'
        ...
        <div className='mycontainer py-4 flex items-center justify-between'>
            ...
            <div className='hidden md:block'>
                <ul className='flex items-center justify-between gap-2'>
                    ...
                    <Image src={"/Vector.png"} alt='VectorSquare' width={500} height={500} className='w-3 h-5'/>
                    <li className=''>
                        <Link 
                        href={'/'} 
...
export default NavbarDetailLowongan